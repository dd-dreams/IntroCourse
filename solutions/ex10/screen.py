...
class ShapesMaster:
    ...
    def _add_base_shapes(self):
        for i in range(ShapesMaster.ASTEROIDS_TYPES):
            self.add_shape(ShapesMaster.ASTEROID_BASE_SHAPE % (i + 1), ShapesMaster.ASTEROIDS_LAYOUTS[i])
...
class Screen:
    ...
    def _init_graphics(self):
        ...
        scoreFrame.pack()
        score = tkinter.Label(scoreFrame, height=2, width=20, textvariable=self._score_val, fg="Yellow", bg="black")
    ...
    def register_torpedo(self, torpedo):
        ...
        :param torpedo: This is your torpedo object
    ...
    def draw_torpedo(self, torpedo, x, y, heading):
        ...
        :param torpedo: This is your torpedo object (remember to register it before)
        :type torpedo: Torpedo
